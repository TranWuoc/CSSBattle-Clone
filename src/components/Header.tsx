        ...
        <div className="bg-sidebar-gradient sticky z-10 flex h-[60px] items-center justify-between px-[11.2px] py-[16px]">
            ...
            <div className="!leading-0 !mr-[10px] w-1/2 flex-1">
                <div className="font-['Clash Grotesk'] ml-[16px] flex flex-row items-center justify-end gap-[4px] font-medium text-[#6b7b8e]">
                    ...
                    Online
                    <button className="">
                        <div className="!font-['Clash Grotesk'] !ml-[20px] !inline-flex cursor-pointer items-center justify-center rounded-[50px] border-0 bg-[#323f4a] !px-4 !py-[0.7rem] !text-left !font-semibold leading-[1.2] tracking-[0.2px] !text-[#fff] no-underline shadow-[inset_1px_1px_2px_hsla(0,0%,100%,0.1)] transition-[transform,background-color] duration-200 ease-in-out hover:bg-[#43515e]">
                            <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                            ...
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                <li>
                                    <div className="flex items-center gap-2 !text-[#ffdf00]">
                                        ...
                                        <DropdownItem href="/" className="!text-[#ffdf00]">
                                            Upgrade to
                                            <img
                                                height="18"
                                                width="37"
                                ...
                                <li>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <DropdownItem href="/settings" className="!text-[#fff]">
                                            View Profile
                                        </DropdownItem>
                                    </div>
                                </li>
                                <li>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <DropdownItem href="/earnings" className="!text-[#fff]">
                                            My Battles
                                        </DropdownItem>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <DropdownItem href="/login" className="!text-[#fff]" onClick={handleLogout}>
                                            Logout
                                        </DropdownItem>
                                    </div>
                                </li>
