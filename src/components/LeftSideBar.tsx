        ...
        <div className="!mt-[16px] h-[64px]">
            ...
            <a className="[&_svg]:text-current] !mt-[10px] flex h-[35px] cursor-pointer items-center gap-2 !pl-[32px] [&:hover_svg]:!transform-none">
                <svg width="40" height="40" viewBox="0 0 20 20" style={{ transform: 'rotate(-90deg)' }}>
                    <circle r="7.5" cx="10" cy="10" fill="transparent" stroke="#323f4a" strokeWidth="2.5px"></circle>
                    <circle
                        r="7.5"
                        cx="10"
                        cy="10"
                ...
                <svg className="!mr-[20px] h-6 w-6" viewBox="0 0 24 24" fill="gray" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="text-custom-gray flex flex-col">
                        ...
                        >
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                <li>
                                    <div className="flex items-center gap-2">
                                        <div className="relative flex h-[20px] w-[20px] items-center justify-center rounded-full border-[2px] border-[#616f39]"></div>
                                        <DropdownItem href="/" className="!text-[#fff]">
                                            Create an account
                                        </DropdownItem>
                                    </div>
                                </li>
                            ...
                            <div className="!mb-[16px] h-[1px] w-[100%] bg-[#27313a]"></div>
                            <span className="font-['Clash Grotesk'] text-[16px] font-bold text-[#6b7b8e]">
                                Explore More
                            </span>
                            <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                <li>
                            ...
                            <div className="h-[1px] w-[100%] bg-[#27313a]"></div>
                            <ul>
                                <li>
                                    <DropdownItem href="/" className="!text-[#fff]">
                                        Skip onboarding
                        ...
                        <div className="!mt-[16px]">
                            ...
                            <div className="block !pl-[32px] [unicode-bidi:isolate]">
                                ...
                                <a className="lex flex h-[35px] cursor-pointer">
                                    ...
                                    <span className="!mr-4 ml-2 rounded bg-[rgba(255,223,0,0.15)] !px-[0.4rem] !py-[0.1rem] text-xs font-[IBM_Plex_Mono] uppercase text-[#ffdf00] shadow-[inset_1px_1px_2px_rgba(255,223,0,0.2)]">
                                        ongoing
                                    </span>
                                </a>
                                <a className="lex flex h-[35px] cursor-pointer">
            ...
            <div className="border-r border-[#20262e] px-[16px] pb-[16px]">
                <div className="flex flex-col gap-[16px]">
                    ...
                    <a className="relative inline-flex w-full cursor-pointer items-center justify-center rounded-[40px] border-0 bg-[rgba(255,255,255,0.1)] px-4 py-[0.7rem] text-left !font-semibold leading-[1.2] tracking-[0.2px] !text-[white] no-underline shadow-[inset_1px_1px_2px_hsla(0,0%,100%,0.1)] transition-[transform,background-color] ease-in-out">
                        ...
                        />
                        <span className="button__border absolute inset-0 animate-border-rotation animate-border-x rounded-full" />
                    </a>
                </div>
            </div>
        </div>
